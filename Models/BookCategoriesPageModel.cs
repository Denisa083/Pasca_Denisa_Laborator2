...
namespace Pasca_Denisa_Laborator2.Models
{
    public class BookCategoriesPageModel : PageModel
    {

        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Pasca_Denisa_Laborator2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Pasca_Denisa_Laborator2Context context,
